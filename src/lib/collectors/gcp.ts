...
export class GcpCollector extends BaseCollector {
  ...
  async collect(): Promise<RawRegionData[]> {
    ...
    try {
      // GCP Region 元数据（来源：官方 Locations 页面 https://cloud.google.com/about/locations）
      const gcpRegions: RawRegionData[] = [
        ...
        // Asia Pacific
        { vendor: "gcp", region_id: "asia-east1", region_name: "Taiwan", country: "China", city: "台北", az_names: ["asia-east1-a","asia-east1-b","asia-east1-c"], status: "active", region_type: "public", data_source_url: sourceUrl },
