...
```bash
# 克隆仓库
git clone https://github.com/你的用户名/cloud-region-explorer.git
...
```bash
docker pull 你的用户名/cloud-region-explorer:latest
docker run -d -p 3000:3000 -v ./data:/app/data --name cloud-region-explorer 你的用户名/cloud-region-explorer:latest
```
